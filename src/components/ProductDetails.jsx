                            ...
                            <section className='flex flex-col h-auto border-x border-black'>
                                <div className='flex flex-col h-auto w-full border-b border-black'>
                                    ...
                                    <div className='flex flex-col w-full h-auto gap-5 p-8 justify-start items-start'>
                                        {nutrition.map((ntr) => (
                                            <div key={ntr.id} className='flex w-full text-black justify-between'>
                                                <p>{ntr.scope}</p>
                                                <p>{ntr.qty}</p>
                                            </div>
                                        ))}
                                ...
                                <div className='flex flex-col h-auto w-full '>
                                    ...
                                    <div className='flex flex-col gap-6 p-8 justify-between items-center'>
                                        ...
                                        <p>farms that reduce environmental impact by at least 25%</p>
                                    </div>
                                </div>
                            </section>
                            {/* tale sub and stash */}
                                ...
                                <div className='flex flex-col h-full w-full border-b border-black'>
                                    ...
                                    <div className='w-full flex flex-col h-auto gap-5 p-8 justify-start items-start'>
                                        <div className='flex w-full flex-col items-center gap-6 h-auto text-left justify-between'>
                                            <p className='w-full'>The Celtics believe these sea astronauts will bless you with bountiful wisdom. </p>
                                            <p className='w-full'>The Celtics believe these sea astronauts will bless you with bountiful wisdom. </p>
                                        </div>
                                        ...
                                        <div className='flex flex-col gap-4'>
                                            <div className='w-full flex justify-start gap-x-3'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#030712" strokeWidth="1.5" />
                                                    <path d="M7.25 12.75L10.75 15.75L16.75 8.25" stroke="#030712" strokeWidth="1.5" />
                                                </svg>
                                                <p className='w-full'>Flat 5% off on all subscriptions</p>
                                            </div>
                                            <div className='w-full flex justify-start gap-x-3'>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                    <path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" stroke="#030712" strokeWidth="1.5" />
                                                    ...
                                                    <button className='h-full w-auto border border-black p-2 text-center'>
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                            <g clipPath="url(#clip0_2591_4101)">
                                                                <path d="M10 0.833313V19.1666" stroke="#030712" strokeWidth="1.25" />
                                                                <path d="M0.833496 10H19.1668" stroke="#030712" strokeWidth="1.25" />
                                                            </g>
                                                            <defs>
                            ...
                            <div className='flex flex-col justify-start gap-10 p-8 items-start py-6 px-8'>
                                <div className='flex w-full justify-start items-center gap-6'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                        <path d="M12 36H36V44H12V36Z" stroke="#030712" strokeWidth="3" />
                                        <path d="M14 8H34V16H14V8Z" stroke="#030712" strokeWidth="3" />
                                    ...
                                    <p className='text-2xl text-left'>  Season breasts with salt and pepper on both sides. Dredge chicken in flour, lightly coating both sides; pat off excess
                                    </p>
                                </div>
                                <div className='flex w-full justify-start items-center gap-6'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                        <path d="M10 4H38V30H10V4Z" stroke="#030712" strokeWidth="3" />
                                        <path d="M38 8H46" stroke="#030712" strokeWidth="3" />
                                        <path d="M2 8H10" stroke="#030712" strokeWidth="3" />
                                        <path d="M8 41.5V41L11.5 36.5L15 41V41.5C15 43.433 13.433 45 11.5 45C9.567 45 8 43.433 8 41.5Z" stroke="#030712" strokeWidth="3" />
                                        <path d="M33 41.5V41L36.5 36.5L40 41V41.5C40 43.433 38.433 45 36.5 45C34.567 45 33 43.433 33 41.5Z" stroke="#030712" strokeWidth="3" />
                                        <path d="M20.5 41.5V41L24 36.5L27.5 41V41.5C27.5 43.433 25.933 45 24 45C22.067 45 20.5 43.433 20.5 41.5Z" stroke="#030712" strokeWidth="3" />
                                    </svg>
                                    <p className='text-2xl text-left'> Heat oil in a large nonstick skillet over medium-high heat. Add butter and swirl until melted. Place chicken in skillet, top sides down. Reduce heat to medium and sauté 7 minutes
                                    </p>
                                </div>
                                <div className='flex w-full justify-start items-center gap-6'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                                        <path d="M10 16H30V32H10V16Z" stroke="#030712" strokeWidth="3" />
                                        <path d="M4 10H44V38H4V10Z" stroke="#030712" strokeWidth="3" />
                                        <path d="M35.5 17H38.5" stroke="#030712" strokeWidth="3" />
                                        <path d="M35.5 24H38.5" stroke="#030712" strokeWidth="3" />
                                    </svg>
                                    <p className='text-2xl text-left'> Leave drippings in skillet. To make one of the delicious sauces listed above, add ingredients and deglaze the pan (i.e., scrape it to loosen cooked bits).
                                    </p>
                                </div>
                            </div>
                        </section>
                                ...
                                <div className='flex flex-col w-full gap-y-4'>
                                    ...
                                    <div className='flex w-auto justify-start gap-x-5'>
                                        <div className='rounded-full border p-3 border-black'>
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                <path d="M6 11.5V21" stroke="#030712" strokeWidth="1.5" />
                                                <path d="M19.5 21H2V11.5H6L8.5 3H9.4C11.3882 3 13 4.61177 13 6.6V9H22L19.5 21Z" stroke="#030712" strokeWidth="1.5" />
                                            </svg>
                                        </div>
