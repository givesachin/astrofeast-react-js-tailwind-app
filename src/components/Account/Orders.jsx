            ...
            <section className='lg:px-16  border-t border-black'>
                ...
                <div className='w-full border-t h-auto flex md:flex-wrap flex-col md:flex-row lg:border-x border-black '>
                    ...
                    <div className='md:pl-6 order-3 pb-3  '>
                        <p className='order-3 px-6 border-black font-poppins flex flex-col justify-evenly text-start'>Check previous orders. Track your current orders.</p>
                    </div>
                    <div className='md:pr-6 order-2 md:w-1/2 flex md:justify-end'>
                        <input className='flex text-3xl md:text-xl py-6 px-6 text-[#F4A73F] font-Staatliches' type="submit" value="reedem code" />
                    </div>
                </div>
                        ...
                        <div key={index} className='flex flex-col'>
                            <div className='flex px-6 py-6 flex-col w-full h-full border-black justify-between gap-5'>
                                <div className='flex justify-between'>
                                    <div>
                                        <p className='text-3xl md:text-2xl h-auto font-Staatliches flex items-center justify-start'>order #{item.order_number}</p>
                                        <p className='text-base md:text-sm font-medium font-poppins justify-start flex'>No of meals: {item.no_of_meals}</p>
                                    </div>
                                    <div>
                                        <input className='hidden md:flex md:px-6 md:py-3 md:text-white md:font-Staatliches md:bg-black md:object-start' type="submit" value="track order" />
                                    </div>
                                ...
                                <div className='flex flex-wrap justify-between w-full  md:w-3/4'>
                                    <div className='w-1/2 md:w-auto ' >
                                        <p className='text-sm md:text-xs font-poppins justify-start flex'>Status</p>
                                        <p className='text-base md:text-sm font-semibold font-poppins justify-start flex pt-1 md:pt-2'>{item.status}</p>

                                    </div>
                                    <div className='w-1/2 md:w-auto ' >
                                        <p className='text-sm md:text-xs font-poppins justify-start flex'> Shipped to</p>
                                        <p className='text-base md:text-sm font-semibold font-poppins justify-start flex pt-1 md:pt-2'>{item.shipped_to}</p>
                                    </div>
                                    <div className='pt-6 md:pt-0' >
                                        <p className='text-sm md:text-xs font-poppins justify-start flex'>Order Date</p>
                                        <p className='text-base md:text-sm font-semibold font-poppins justify-start flex pt-1 md:pt-2'>{item.order_date}</p>
                                    </div>
                                </div>
                                <div className='md:hidden'>
                                        <input className='w-full flex py-4 text-white font-Staatliches bg-black justify-center text-xl' type="submit" value="track order" />
                                    </div>
                            </div>
