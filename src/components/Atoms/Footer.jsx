        ...
        <div className="lg:border-r w-full border-black">
          ...
          <div className="px-6 md:px-16 py-8 lg:p-16 gap-y-9 flex flex-col items-start">
            ...
            <div className="w-full gap-y-2 flex flex-col items-start ">
              ...
              >
                <input
                  className="w-full md:w-3/4 p-4 border border-black placeholder:text-black font-poppins"
                  type="text"
                  placeholder="Email/Whatsapp"
                />
                <input
                  className="w-full px-6 py-3 text-white font-Staatliches  bg-black lg:w-auto md:w-1/4 text-xl md:tracking-wider"
                  type="submit"
