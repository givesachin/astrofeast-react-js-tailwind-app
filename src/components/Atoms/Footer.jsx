        ...
        <footer className='w-full lg:flex lg:items-center lg:flex-col'>
            <div className='w-full  lg:flex border-t border-black'>
                <div className='lg:border-r w-full border-black'>
                    <p className='px-8 py-3 md:px-16 md:py-6 text-start border-b text-xl font-medium font-poppins uppercase border-black'>Stay up with Astrofeast</p>
                ...
                <div className='flex w-full lg:border-white border-t border-black'>
                    <div className='w-1/2 md:w-full flex flex-col border-r border-black'>
                        <p className='px-8 md:px-16 py-4 md:py-6 text-start border-b text-lg font-medium uppercase border-black font-poppins'>work with us</p>
