...
const Sidebar = () => {
  ...
  return (
    <>
      {hide ? (
        <section className="overflow-hidden w-screen h-screen absolute top-0  z-50 flex flex-row-reverse bg-black/50">
                ...
                <div class="absolute inset-0 overflow-hidden">
                  <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
                    <div class="pointer-events-auto relative w-screen max-w-4xl">
                      <div class="max-w-4xl flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                          ...
                          <div className="flex w-full h-auto flex-wrap md:flex-nowrap items-center gap-x-7">
                            ...
                            <div className="mx-10 md:mx-1 order-4 md:mr-20 lg:mr-40 md:order-1 pt-10 md:pt-0 h-fit md:w-1/2 w-full gap-x-2 flex border-b-2 py-[0.6rem] border-black items-center">
                              <img
                                src={afsearch}
                                alt="search"
                                className=" h-6 w-fit  font-bold"
                              />
                              <input
                                className="w-[15.875rem]  text-black placeholder:text-black text-sm bg-white focus:outline-none"
                                type="text"
                                placeholder="Search / Track Order"
                              />
                            </div>
                            {/* other icons */}
                            <div className="order-2 w-auto h-auto align-bottom ">
                            ...
                            <div className="pl-2 md:pl-5 pr-36 md:pr-5 order-1 md:order-4">
                              <img
                                onClick={() => {
                                  setHide(!hide);
                                  console.log("click from sidebar", hide);
                                }}
                                className=" h-5"
                                src={afclose}
                                alt="menu"
